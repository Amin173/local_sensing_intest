...
from sensor_msgs.msg import PointCloud, Range, LaserScan, PointField, PointCloud2
...
import math
from local_sensing_intest.srv import PointCloud2Request
...
class HoghmanFilter:
    ...
    def set_cloud(self, cloud_xyz):
        ...
        # self.adjust_lines2()
        # self.lines = self.merge(self.lines)
        # self.lines = self.adjust_corners()

        # for line in self.lines:
        #     x1, y1, x2, y2 = line
        #     cv2.line(self.image, (x1, y1), (x2, y2), (36, 255, 12), 3)
        # cv2.imshow(self.window, self.image)
        # cv2.moveWindow(self.window, 0, 200)
        # cv2.waitKey(0)
